...
The Python version (this depends on :ref:`/bareos/config-file/v2:build.image`).
...
.. warning::
  ...
  If you are using a :ref:`Conda </bareos/config-file/v2:conda>` environment to manage
...
.. warning::
  ...
  If you are using a :ref:`Conda </bareos/config-file/v2:conda>` environment to
...
Depending on the :ref:`/bareos/config-file/v2:build.image`,
Read the Docs includes some libraries like scipy, numpy, etc.
That you can access to them by enabling this option.
See :doc:`/bareos/builds` for more details.

.. warning::

  If you are using a :ref:`Conda </bareos/config-file/v2:conda>` environment
...
check :ref:`/bareos/config-file/v2:search.ignore`.
...
- The version setting is required. See :ref:`/bareos/config-file/v2:version`.
- The default value of the :ref:`/bareos/config-file/v2:formats` setting has changed to ``[]``
...
- The top setting ``requirements_file`` was moved to ``python.install``
  ...
  See :ref:`/bareos/config-file/v2:Requirements file`.
- The setting ``conda.file`` was renamed to ``conda.environment``.
  See :ref:`/bareos/config-file/v2:conda.environment`.
- The ``build.image`` setting now only has two options: ``latest`` (default) and ``stable``.
  See :ref:`/bareos/config-file/v2:build.image`.
- The settings ``python.setup_py_install`` and ``python.pip_install`` were replaced by ``python.install``.
  ...
  See :ref:`/bareos/config-file/v2:Packages`.
- The setting ``python.use_system_site_packages`` was renamed to ``python.system_packages``.
  See :ref:`/bareos/config-file/v2:python.system_packages`.
- The build will fail if there are invalid keys (strict mode).

.. warning::

   Some values from the web interface are no longer respected,
   please see :ref:`/bareos/config-file/v2:Migrating from the web interface` if you have settings there.

New settings
~~~~~~~~~~~~

- :ref:`/bareos/config-file/v2:sphinx`
- :ref:`/bareos/config-file/v2:mkdocs`
- :ref:`/bareos/config-file/v2:submodules`
- :ref:`/bareos/config-file/v2:python.install`
- :ref:`/bareos/config-file/v2:search`
...
and find their respective setting in :ref:`here </bareos/config-file/v2:Supported settings>`.
