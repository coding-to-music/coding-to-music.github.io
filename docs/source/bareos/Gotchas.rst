...
.. Note:: 
    ...
    https://github.com/bareos/bareos/blob/bareos-20/docs/manuals/bareos/Gotchas.rst
...
When using :ref:`bareos/RestOverview:Directives`, they are prepanded by the comment directives: ''.. ''
...
If the link target :ref:`bareos/BareosSpecificFormatting/BareosConfiguration:Reference to a Resource Directive` is unknown,
...
This only applies to ``:options:`` without domain. We do you ``:config:option:`` in :ref:`bareos/BareosSpecificFormatting/BareosConfiguration:Bareos Configuration`.
