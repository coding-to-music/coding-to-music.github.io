...
.. Note:: 
    ...
    https://github.com/bareos/blob/master/docs/manuals/bareos/BareosSpecificFormatting/BareosConfiguration.rst
...
::
   ...
   .. literalinclude:: /bareos/include/config/bareos-sd.d/device/FileStorage.conf
      :language: bareosconfig
      :caption: bareos-dir.d/job/consolidate.conf

All configuration snippets should be located in the :file:`/bareos/include/config/` subdirectory of the documentation.
...
The documenation outline for resource directives is autogenerated (by https://github.com/bareos/blob/master/docs/manuals/scripts/generate-resoure-descriptions.py) and stored into the https://github.com/bareos/tree/master/docs/manuals/bareos/include/autogenerated/ directory.
...
.. note::
   ...
   If the reference to a Resource Directive does not match a  :ref:`bareos/BareosSpecificFormatting/BareosConfiguration:Resource Directive Definition`,
