...
.. warning::
   ...
   See the :ref:`new features </bareos/guides/config-file/v2:New settings>`
   and :ref:`how to migrate from v1 </bareos/guides/config-file/v2:Migrating from v1>`.
...
.. warning::
    ...
    See :ref:`/bareos/guides/config-file/v1:build.image` for more information on supported Python versions.
...
Depending on the :ref:`/bareos/guides/config-file/v1:build.image`,
