...
or by :ref:`using a configuration file </bareos/guides/reproducible-builds:using a configuration file>` (recommended).
...
Always declare your dependencies explicitly using a :ref:`configuration file </bareos/guides/reproducible-builds:using a configuration file>`,
for example:
...
or our Conda docs about :ref:`environment files </bareos/guides/conda:creating the \`\`environment.yml\`\`>`.
